...
from vaccination.models import States
...
admin.site.register(Assam)
admin.site.register(Bihar)
admin.site.register(Chandigarh)
admin.site.register(Chhattisgarh)
admin.site.register(Dadra_and_nagar_haveli)
admin.site.register(Daman_and_diu)
admin.site.register(Delhi)
admin.site.register(Goa)
admin.site.register(Gujarat)
admin.site.register(Haryana)
admin.site.register(Himachal_pradesh)
admin.site.register(Jammu_and_kashmir)
admin.site.register(Jharkhand)
admin.site.register(Karnataka)
admin.site.register(Kerala)
admin.site.register(Ladakh)
admin.site.register(Lakshadweep)
admin.site.register(Madhya_pradesh)
admin.site.register(Maharashtra)
admin.site.register(Manipur)
admin.site.register(Meghalaya)
admin.site.register(Mizoram)
admin.site.register(Nagaland)
admin.site.register(Odisha)
admin.site.register(Puducherry)
admin.site.register(Punjab)
admin.site.register(Rajasthan)
admin.site.register(Sikkim)
admin.site.register(Tamil_nadu)
admin.site.register(Telangana)
admin.site.register(Tripura)
